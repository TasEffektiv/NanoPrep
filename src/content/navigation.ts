...
export const caseStudiesDropdown: NavDropdown = {
  ...
  items: [
    { label: "Pipework Corrosion Protection", href: "/case-studies/pipework-corrosion-protection-without-blasting" },
    { label: "Fuel Tank Corrosion Protection", href: "/case-studies/fuel-tank-corrosion-protection-without-blasting" },
    { label: "External Coating of Ash Hopper", href: "/case-studies/external-coating-of-ash-hopper" },
    { label: "Water Tank — Power Plant", href: "/case-studies/water-tank-corrosion-protection" },
    { label: "Eco-Friendly Pylon Protection", href: "/case-studies/eco-friendly-solution-for-pylon-corrosion-protection" },
    { label: "Overhead Crane Restoration", href: "/case-studies/overhead-crane-restoration" },
    { label: "Structural Steel Column", href: "/case-studies/structural-steel-column" },
