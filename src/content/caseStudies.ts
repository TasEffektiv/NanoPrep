...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    metaDescription:
      "NanoPrep provides unique solution for eco-friendly surface preparation. Perfect solution for common corrosion issues on pylons.",
    ...
    heroSub: "Perfect solution for common corrosion issues on pylons",
    heroImage: {
      src: "https://rezitech.com.au/wp-content/uploads/2025/10/NanoPrep-pile-protection-coating-used-on-jetty.jpg",
      alt: "NanoPrep pile protection coating used on jetty",
    },
    listImage: {
      src: "https://rezitech.com.au/wp-content/uploads/2024/12/Pier-in-tidal-zone-with-pylons-corrosion-protected.jpg",
    ...
    blocks: [
      ...
      { type: "paragraph", text: "Until now, there have been no products on the market that provide a good long-term solution to this problem." },
      { type: "paragraph", text: "Introducing NanoPrep!" },
      {
        type: "imageGroup",
        variant: "plain",
        images: [
          ...
          { caption: "Pier pylons during corrosion protection work", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Pier-pylons-during-corrosion-protection-work.jpg", alt: "Pier pylons during corrosion protection work" },
          { caption: "Pier pylons in tidal zone after corrosion protection work", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Pier-pylons-in-tidal-zone-after-corrosion-protection-work.jpg", alt: "Pier pylons in tidal zone after corrosion protection work" },
        ],
      },
      { type: "heading", text: "The Application" },
      { type: "paragraph", text: "NanoPrep provides the perfect eco-friendly surface preparation solution. The product converts rust into an iron phosphate layer that adheres very strongly to the substrate through nanotechnology. The product also has high tolerance to chlorides due to its acidic base which neutralises the chlorides. This provides a high quality surface preparation for appropriate coatings to be used." },
      { type: "paragraph", text: "As the tide goes down, the pylons are pressure washed to remove loose rust scale. One coat of NanoPrep is applied and left for two hours to dry. Belzona 5831 moisture tolerant epoxy is then applied, which can cure underwater as the tide rises. The next day, a gentle pressure wash to remove surface chlorides and then a thin coat of NanoPrep is applied and left for two hours. The final coat of Wattyl DTM985 is then applied for UV and immersion protection." },
      { type: "paragraph", text: "Job done!" },
      {
        type: "imageGroup",
        variant: "plain",
        imageAspectRatio: "400 / 1025",
        images: [
          { caption: "Original Pylon", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Original-Pylon-before-surface-preparation.jpg", alt: "Original Pylon before surface preparation" },
          { caption: "NanoPrep Coating", src: "https://rezitech.com.au/wp-content/uploads/2024/12/NanoPrep-Coating-on-pier-pylon.jpg", alt: "NanoPrep Coating on pier pylon" },
          { caption: "Belzona 5831", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Belzona-5831-applied-to-pier-pylon.jpg", alt: "Belzona 5831 applied to pier pylon" },
          { caption: "Wattyl DTM985", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Pylon-coted-in-Wattyl-DTM985.jpg", alt: "Pylon coted in Wattyl DTM985" },
        ],
      },
      { type: "heading", text: "The Outcome" },
      { type: "paragraph", text: "This application was completed 18 months ago at the time of publishing and is still in perfect condition." },
      {
        type: "imageGroup",
        variant: "plain",
        images: [
  ...
  },
  {
    ...
    metaDescription:
      "NanoPrep provides surface preparation and corrosion protection to an overhead crane without abrasive blasting.",
    breadcrumbLabel: "Overhead Crane Restoration",
    industryKey: "pulp-paper",
    industryLabel: "Pulp & Paper",
    title: "Overhead Crane Restoration",
    heroSub: "NanoPrep provides surface preparation and corrosion protection without blasting",
    heroImage: {
      src: "https://rezitech.com.au/wp-content/uploads/2024/12/Application-of-NanoPrep-on-rusted-crane.jpg",
      alt: "Application of NanoPrep on rusted crane",
    },
    listImage: {
      src: "https://rezitech.com.au/wp-content/uploads/2024/12/Overhead-crane-protected-from-corrosion-with-NanoPrep.jpg",
    ...
    blocks: [
      { type: "heading", text: "The Problem" },
      { type: "paragraph", text: "Pulp and Paper facilities are renowned for their corrosive environments which necessitates their steel structures, including this overhead crane, to be maintained and protected against these elements." },
      { type: "paragraph", text: "Due to being 20 metres overhead and surrounded by critical equipment, abrasive blasting was not an option so the client needed an alternative type of surface preparation for a protective coating to be applied." },
      {
        type: "imageGroup",
        variant: "plain",
        images: [
      ...
      { type: "heading", text: "The Application" },
      { type: "paragraph", text: "NanoPrep provided the perfect solution for this application." },
      { type: "paragraph", text: "First, the crane was high pressure washed at 3,500psi to remove loose rust, coating and any contaminants off the surface. Thereafter, two coats of NanoPrep were applied by airless spray. Finally, two coats of Jotun XP Hardtop in safety yellow were applied to provide added long term protection and a nice aesthetic finish." },
      { type: "paragraph", text: "The job was done during regular operating hours without causing disruptions or requiring production to be stopped." },
      {
        type: "imageGroup",
        variant: "plain",
        images: [
          { caption: "Two coats of NanoPrep applied by airless spray", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Application-of-NanoPrep-via-spray-gun.jpg", alt: "Application of NanoPrep via spray gun" },
          { caption: "NanoPrep applied over pressure washed surface", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Protective-coating-being-applied-to-overhead-crane.jpeg", alt: "Protective coating being applied to overhead crane" },
          { caption: "Jotun XP Hardtop being applied", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Jotun-XP-Hardtop-applied-over-NanoPrep-on-crane.jpg", alt: "Jotun XP Hardtop applied over NanoPrep on crane" },
        ],
      },
      { type: "heading", text: "The Outcome" },
      { type: "paragraph", text: "Previously, during 2019, the client had the other crane’s walkways and motor pans coated in NanoPrep as a trial. Five years later, they are still in perfect condition and as a result the client decided to coat another crane that was showing signs of degradation." },
      { type: "paragraph", text: "The client is very happy with the result and requested additional cranes and other equipment to be protected using NanoPrep." },
      {
        type: "imageGroup",
        variant: "plain",
        images: [
          { caption: "Completed restoration of overhead crane", src: "https://rezitech.com.au/wp-content/uploads/2024/12/Overhead-crane-protected-from-corrosion-with-NanoPrep.jpg", alt: "Overhead crane protected from corrosion with NanoPrep" },
        ],
      },
      { type: "heading", text: "Project Specification" },
